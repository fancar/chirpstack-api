...
func (x *UplinkEvent) GetBatTime() *timestamp.Timestamp {
	if x != nil {
		return x.BatTime
	}
	return nil
...
type LartechUplinkEvent struct {
	...
	Fport        *wrappers.Int32Value            `protobuf:"bytes,13,opt,name=fport,proto3" json:"fport,omitempty"`               // Порт данных
	FrmPayload   []byte                          `protobuf:"bytes,14,opt,name=frmPayload,proto3" json:"frmPayload,omitempty"`     // Принятые данные
	Owner        *wrappers.StringValue           `protobuf:"bytes,15,opt,name=owner,proto3" json:"owner,omitempty"`               // Владелец устройства
	Stat         *wrappers.Int32Value            `protobuf:"bytes,16,opt,name=stat,proto3" json:"stat,omitempty"`                 // Необязательное поле
	RfChain      *wrappers.Int32Value            `protobuf:"bytes,17,opt,name=rfChain,proto3" json:"rfChain,omitempty"`           // Необязательное поле
	Size         *wrappers.Int32Value            `protobuf:"bytes,18,opt,name=size,proto3" json:"size,omitempty"`                 // Необязательное поле
	Firmware     *wrappers.StringValue           `protobuf:"bytes,19,opt,name=firmware,proto3" json:"firmware,omitempty"`         // Необязательное поле
	FirstMessage *wrappers.BoolValue             `protobuf:"bytes,20,opt,name=firstMessage,proto3" json:"firstMessage,omitempty"` // Необязательное поле
}
...
func (x *LartechUplinkEvent) GetFport() *wrappers.Int32Value {
	if x != nil {
		return x.Fport
	}
	return nil
...
func (x *LartechUplinkEvent) GetOwner() *wrappers.StringValue {
	if x != nil {
		return x.Owner
	}
	return nil
...
func (x *LartechUplinkEvent) GetStat() *wrappers.Int32Value {
	if x != nil {
		return x.Stat
	}
	return nil
...
func (x *LartechUplinkEvent) GetRfChain() *wrappers.Int32Value {
	if x != nil {
		return x.RfChain
	}
	return nil
...
func (x *LartechUplinkEvent) GetSize() *wrappers.Int32Value {
	if x != nil {
		return x.Size
	}
	return nil
...
func (x *LartechUplinkEvent) GetFirmware() *wrappers.StringValue {
	if x != nil {
		return x.Firmware
	}
	return nil
...
func (x *LartechUplinkEvent) GetFirstMessage() *wrappers.BoolValue {
	if x != nil {
...
type LartechDownlink struct {
	...
	Retries             *wrappers.Int32Value  `protobuf:"bytes,4,opt,name=retries,proto3" json:"retries,omitempty"`                          // 0 = Unconfirmed downlink, 1…N = Confirmed downlink с количеством попыток доставки 1…N
	Fport               *wrappers.Int32Value  `protobuf:"bytes,5,opt,name=fport,proto3" json:"fport,omitempty"`                              // Порт данных
	...
	Owner               *wrappers.StringValue `protobuf:"bytes,9,opt,name=owner,proto3" json:"owner,omitempty"`                              // Владелец устройства
	...
	AlreadySentChunks   *wrappers.Int32Value  `protobuf:"bytes,11,opt,name=alreadySentChunks,proto3" json:"alreadySentChunks,omitempty"`     // Необязательное поле
	DownlinkType        *DownlinkType         `protobuf:"bytes,12,opt,name=downlinkType,proto3" json:"downlinkType,omitempty"`               // Необязательное поле
	TimeZoneHours       *wrappers.Int32Value  `protobuf:"bytes,13,opt,name=timeZoneHours,proto3" json:"timeZoneHours,omitempty"`             // Необязательное поле
}
...
func (x *LartechDownlink) GetRetries() *wrappers.Int32Value {
	if x != nil {
		return x.Retries
	}
	return nil
...
func (x *LartechDownlink) GetFport() *wrappers.Int32Value {
	if x != nil {
		return x.Fport
	}
	return nil
...
func (x *LartechDownlink) GetOwner() *wrappers.StringValue {
	if x != nil {
		return x.Owner
	}
	return nil
...
func (x *LartechDownlink) GetAlreadySentChunks() *wrappers.Int32Value {
	if x != nil {
...
func (x *LartechDownlink) GetTimeZoneHours() *wrappers.Int32Value {
	if x != nil {
...
type LartechDownlinkMessageStatus struct {
	...
	StatusDescription *wrappers.StringValue `protobuf:"bytes,4,opt,name=statusDescription,proto3" json:"statusDescription,omitempty"`                   // Необязательное поле
	AppId             string                `protobuf:"bytes,5,opt,name=appId,proto3" json:"appId,omitempty"`                                           // Значение «MeteringServer»
	Owner             *wrappers.StringValue `protobuf:"bytes,6,opt,name=owner,proto3" json:"owner,omitempty"`                                           // Владелец устройства
...
func (x *LartechDownlinkMessageStatus) GetStatusDescription() *wrappers.StringValue {
	if x != nil {
...
func (x *LartechDownlinkMessageStatus) GetOwner() *wrappers.StringValue {
	if x != nil {
		return x.Owner
	}
	return nil
...
func (x *UplinkDefault) GetTime() *timestamp.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
func (x *UplinkDefault) GetBatTime() *timestamp.Timestamp {
	if x != nil {
		return x.BatTime
	}
	return nil
...
var file_as_integration_integration_proto_rawDesc = []byte{
	...
	0x07, 0x42, 0x6e, 0x0a, 0x20, 0x69, 0x6f, 0x2e, 0x63, 0x68, 0x69, 0x72, 0x70, 0x73, 0x74, 0x61,
	0x63, 0x6b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x73, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x67, 0x72,
