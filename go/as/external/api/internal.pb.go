...
type GetInfoResponse struct {
	...
	// mosquito version
	Mosquito             string   `protobuf:"bytes,9,opt,name=mosquito,proto3" json:"mosquito,omitempty"`
...
func (m *GetInfoResponse) GetMosquito() string {
	if m != nil {
		return m.Mosquito
	}
	return ""
...
var fileDescriptor_2d2de8ef40b5c6ca = []byte{
	...
	,
}
