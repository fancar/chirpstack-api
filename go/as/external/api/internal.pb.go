...
type GlobalSearchResult struct {
	...
	// routing profile id.
	RoutingProfileId int64 `protobuf:"varint,5,opt,name=routing_profile_id,json=routingProfileID,proto3" json:"routing_profile_id,omitempty"`
	// routing profile name.
	RoutingProfileName string `protobuf:"bytes,6,opt,name=routing_profile_name,json=routingProfileName,proto3" json:"routing_profile_name,omitempty"`
...
var fileDescriptor_2d2de8ef40b5c6ca = []byte{
	...
	,
}
