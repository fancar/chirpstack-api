...
type GetInfoResponse struct {
	...
	// postgres version
	Postgres string `protobuf:"bytes,6,opt,name=postgres,proto3" json:"postgres,omitempty"`
	// redis version
	Redis string `protobuf:"bytes,7,opt,name=redis,proto3" json:"redis,omitempty"`
	// mosquito version
	Mosquito             string   `protobuf:"bytes,8,opt,name=mosquito,proto3" json:"mosquito,omitempty"`
...
func (m *GetInfoResponse) GetPostgres() string {
	if m != nil {
		return m.Postgres
	}
	return ""
...
var fileDescriptor_2d2de8ef40b5c6ca = []byte{
	...
	,
}
