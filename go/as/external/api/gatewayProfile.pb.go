...
var file_as_external_api_gatewayProfile_proto_rawDesc = []byte{
	...
	0x74, 0x42, 0x73, 0x0a, 0x21, 0x69, 0x6f, 0x2e, 0x63, 0x68, 0x69, 0x72, 0x70, 0x73, 0x74, 0x61,
	0x63, 0x6b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x73, 0x2e, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x2e, 0x61, 0x70, 0x69, 0x42, 0x13, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x50,
...
func (c *gatewayProfileServiceClient) CountGateways(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CountGatewaysResponse, error) {
	out := new(CountGatewaysResponse)
	err := c.cc.Invoke(ctx, "/api.GatewayProfileService/CountGateways", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedGatewayProfileServiceServer) CountGateways(context.Context, *empty.Empty) (*CountGatewaysResponse, error) {
...
func _GatewayProfileService_CountGateways_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.GatewayProfileService/CountGateways",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayProfileServiceServer).CountGateways(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
