...
func (m *GatewayProfile) GetDesign() string {
	if m != nil {
		return m.Design
	}
	return ""
...
func (m *GatewayProfile) GetGps() bool {
	if m != nil {
		return m.Gps
	}
	return false
...
func (m *GatewayProfile) GetSecure() bool {
	if m != nil {
		return m.Secure
	}
	return false
...
func (m *ListGatewayProfilesRequest) GetOrderBy() string {
	if m != nil {
		return m.OrderBy
	}
	return ""
...
func (m *ListGatewayProfilesRequest) GetOrder() string {
	if m != nil {
		return m.Order
	}
	return ""
...
func (*CountGatewaysResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a425cd68ff0462c4, []int{11}
}
...
func init() {
	...
	proto.RegisterType((*CountGatewaysResponse)(nil), "api.CountGatewaysResponse")
	proto.RegisterMapType((map[string]int64)(nil), "api.CountGatewaysResponse.DataEntry")
}
...
var fileDescriptor_a425cd68ff0462c4 = []byte{
	...
	,
}
...
func (*UnimplementedGatewayProfileServiceServer) CountGateways(ctx context.Context, req *empty.Empty) (*CountGatewaysResponse, error) {
