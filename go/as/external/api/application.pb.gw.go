...
var (
	...
	pattern_ApplicationService_CreateKafkaIntegration_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4}, []string{"api", "applications", "integration.application_id", "integrations", "kakafka"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ApplicationService_GetKafkaIntegration_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4}, []string{"api", "applications", "application_id", "integrations", "kakafka"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ApplicationService_UpdateKafkaIntegration_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4}, []string{"api", "applications", "integration.application_id", "integrations", "kakafka"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ApplicationService_DeleteKafkaIntegration_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4}, []string{"api", "applications", "application_id", "integrations", "kakafka"}, "", runtime.AssumeColonVerbOpt(true)))
