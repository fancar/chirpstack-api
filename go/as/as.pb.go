...
type HandleGatewayStatsRequest struct {
	...
	// true if radio forwarder is running on the gateway
	Radio bool `protobuf:"varint,15,opt,name=radio,proto3" json:"radio,omitempty"`
}
...
func (x *HandleGatewayStatsRequest) GetRadio() bool {
	if x != nil {
		return x.Radio
	}
	return false
...
var file_as_as_proto_rawDesc = []byte{
	...
	0x12, 0x14, 0x0a, 0x05, 0x72, 0x61, 0x64, 0x69, 0x6f, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x08, 0x52,
