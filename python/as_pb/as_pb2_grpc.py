...
class ApplicationServerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HandleUplinkData = channel.unary_unary(
                ...
                request_serializer=as_dot_as__pb2.HandleUplinkDataRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.HandleProprietaryUplink = channel.unary_unary(
                '/as.ApplicationServerService/HandleProprietaryUplink',
                request_serializer=as_dot_as__pb2.HandleProprietaryUplinkRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.HandleError = channel.unary_unary(
                '/as.ApplicationServerService/HandleError',
                request_serializer=as_dot_as__pb2.HandleErrorRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.HandleDownlinkACK = channel.unary_unary(
                '/as.ApplicationServerService/HandleDownlinkACK',
                request_serializer=as_dot_as__pb2.HandleDownlinkACKRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.HandleGatewayStats = channel.unary_unary(
                '/as.ApplicationServerService/HandleGatewayStats',
                request_serializer=as_dot_as__pb2.HandleGatewayStatsRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.HandleTxAck = channel.unary_unary(
                '/as.ApplicationServerService/HandleTxAck',
                request_serializer=as_dot_as__pb2.HandleTxAckRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.SetDeviceStatus = channel.unary_unary(
                '/as.ApplicationServerService/SetDeviceStatus',
                request_serializer=as_dot_as__pb2.SetDeviceStatusRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.SetDeviceLocation = channel.unary_unary(
                '/as.ApplicationServerService/SetDeviceLocation',
                request_serializer=as_dot_as__pb2.SetDeviceLocationRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.GetDevicesSummary = channel.unary_unary(
                '/as.ApplicationServerService/GetDevicesSummary',
                request_serializer=as_dot_as__pb2.GetDevicesSummaryRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.GetDevicesSummaryResponse.FromString,
                _registered_method=True)
        self.GetGatewaysSummary = channel.unary_unary(
                '/as.ApplicationServerService/GetGatewaysSummary',
                request_serializer=as_dot_as__pb2.GetGatewaysSummaryRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.GetGatewaysSummaryResponse.FromString,
                _registered_method=True)
        self.ListOrganisation = channel.unary_unary(
                '/as.ApplicationServerService/ListOrganisation',
                request_serializer=as_dot_as__pb2.ListOrganizationRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.ListOrganizationResponse.FromString,
                _registered_method=True)
        self.GetOrgByDevEUI = channel.unary_unary(
                '/as.ApplicationServerService/GetOrgByDevEUI',
                request_serializer=as_dot_as__pb2.GetOrgByDevEUIRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.GetOrgByDevEUIResponse.FromString,
                _registered_method=True)
        self.GetOrgIDByGwID = channel.unary_unary(
                '/as.ApplicationServerService/GetOrgIDByGwID',
                request_serializer=as_dot_as__pb2.GetOrgIDByGwIDRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.GetOrgByDevEUIResponse.FromString,
                _registered_method=True)
        self.GetDeviceAppSKey = channel.unary_unary(
                '/as.ApplicationServerService/GetDeviceAppSKey',
                request_serializer=as_dot_as__pb2.GetOrgByDevEUIRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.GetDeviceAppSKeyResponse.FromString,
                _registered_method=True)
        self.GetDeviceKeys = channel.unary_unary(
                '/as.ApplicationServerService/GetDeviceKeys',
                request_serializer=as_dot_as__pb2.GetOrgByDevEUIRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.GetDeviceKeysResponse.FromString,
                _registered_method=True)
        self.ReEncryptDeviceQueueItems = channel.unary_unary(
                '/as.ApplicationServerService/ReEncryptDeviceQueueItems',
                request_serializer=as_dot_as__pb2.ReEncryptDeviceQueueItemsRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.ReEncryptDeviceQueueItemsResponse.FromString,
                _registered_method=True)
        self.StreamGatewayTaskResult = channel.stream_unary(
                '/as.ApplicationServerService/StreamGatewayTaskResult',
                request_serializer=as_dot_as__pb2.GatewayTaskResult.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.GetDictionary = channel.unary_unary(
                '/as.ApplicationServerService/GetDictionary',
                request_serializer=as_dot_as__pb2.GetDictionaryRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.GetDictionaryResponse.FromString,
                _registered_method=True)
        self.GetGWMetaData = channel.unary_unary(
                '/as.ApplicationServerService/GetGWMetaData',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=as_dot_as__pb2.GetGWMetaDataResponse.FromString,
                _registered_method=True)
        self.GetServiceProfile = channel.unary_unary(
                '/as.ApplicationServerService/GetServiceProfile',
                request_serializer=as_dot_as__pb2.GetServiceProfileRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.GetServiceProfileResponse.FromString,
                _registered_method=True)
        self.CreateServiceProfile = channel.unary_unary(
                '/as.ApplicationServerService/CreateServiceProfile',
                request_serializer=as_dot_as__pb2.CreateServiceProfileRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.CreateServiceProfileResponse.FromString,
                _registered_method=True)
        self.UpdateSPonDevice = channel.unary_unary(
                '/as.ApplicationServerService/UpdateSPonDevice',
                request_serializer=as_dot_as__pb2.UpdateSPonDeviceRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
        self.NewAppSKey = channel.unary_unary(
                '/as.ApplicationServerService/NewAppSKey',
                request_serializer=as_dot_as__pb2.NewAppSKeyRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.GetDeviceAppSKeyResponse.FromString,
                _registered_method=True)
        self.CheckJwt = channel.unary_unary(
                '/as.ApplicationServerService/CheckJwt',
                request_serializer=as_dot_as__pb2.CheckJwtRequest.SerializeToString,
                response_deserializer=as_dot_as__pb2.CheckJwtResponse.FromString,
                _registered_method=True)
...
def add_ApplicationServerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'HandleUplinkData': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=as_dot_as__pb2.HandleUplinkDataRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'HandleProprietaryUplink': grpc.unary_unary_rpc_method_handler(
                    servicer.HandleProprietaryUplink,
                    request_deserializer=as_dot_as__pb2.HandleProprietaryUplinkRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'HandleError': grpc.unary_unary_rpc_method_handler(
                    servicer.HandleError,
                    request_deserializer=as_dot_as__pb2.HandleErrorRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'HandleDownlinkACK': grpc.unary_unary_rpc_method_handler(
                    servicer.HandleDownlinkACK,
                    request_deserializer=as_dot_as__pb2.HandleDownlinkACKRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'HandleGatewayStats': grpc.unary_unary_rpc_method_handler(
                    servicer.HandleGatewayStats,
                    request_deserializer=as_dot_as__pb2.HandleGatewayStatsRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'HandleTxAck': grpc.unary_unary_rpc_method_handler(
                    servicer.HandleTxAck,
                    request_deserializer=as_dot_as__pb2.HandleTxAckRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'SetDeviceStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.SetDeviceStatus,
                    request_deserializer=as_dot_as__pb2.SetDeviceStatusRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'SetDeviceLocation': grpc.unary_unary_rpc_method_handler(
                    servicer.SetDeviceLocation,
                    request_deserializer=as_dot_as__pb2.SetDeviceLocationRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'GetDevicesSummary': grpc.unary_unary_rpc_method_handler(
                    servicer.GetDevicesSummary,
                    request_deserializer=as_dot_as__pb2.GetDevicesSummaryRequest.FromString,
                    response_serializer=as_dot_as__pb2.GetDevicesSummaryResponse.SerializeToString,
            ),
            'GetGatewaysSummary': grpc.unary_unary_rpc_method_handler(
                    servicer.GetGatewaysSummary,
                    request_deserializer=as_dot_as__pb2.GetGatewaysSummaryRequest.FromString,
                    response_serializer=as_dot_as__pb2.GetGatewaysSummaryResponse.SerializeToString,
            ),
            'ListOrganisation': grpc.unary_unary_rpc_method_handler(
                    servicer.ListOrganisation,
                    request_deserializer=as_dot_as__pb2.ListOrganizationRequest.FromString,
                    response_serializer=as_dot_as__pb2.ListOrganizationResponse.SerializeToString,
            ),
            'GetOrgByDevEUI': grpc.unary_unary_rpc_method_handler(
                    servicer.GetOrgByDevEUI,
                    request_deserializer=as_dot_as__pb2.GetOrgByDevEUIRequest.FromString,
                    response_serializer=as_dot_as__pb2.GetOrgByDevEUIResponse.SerializeToString,
            ),
            'GetOrgIDByGwID': grpc.unary_unary_rpc_method_handler(
                    servicer.GetOrgIDByGwID,
                    request_deserializer=as_dot_as__pb2.GetOrgIDByGwIDRequest.FromString,
                    response_serializer=as_dot_as__pb2.GetOrgByDevEUIResponse.SerializeToString,
            ),
            'GetDeviceAppSKey': grpc.unary_unary_rpc_method_handler(
                    servicer.GetDeviceAppSKey,
                    request_deserializer=as_dot_as__pb2.GetOrgByDevEUIRequest.FromString,
                    response_serializer=as_dot_as__pb2.GetDeviceAppSKeyResponse.SerializeToString,
            ),
            'GetDeviceKeys': grpc.unary_unary_rpc_method_handler(
                    servicer.GetDeviceKeys,
                    request_deserializer=as_dot_as__pb2.GetOrgByDevEUIRequest.FromString,
                    response_serializer=as_dot_as__pb2.GetDeviceKeysResponse.SerializeToString,
            ),
            'ReEncryptDeviceQueueItems': grpc.unary_unary_rpc_method_handler(
                    servicer.ReEncryptDeviceQueueItems,
                    request_deserializer=as_dot_as__pb2.ReEncryptDeviceQueueItemsRequest.FromString,
                    response_serializer=as_dot_as__pb2.ReEncryptDeviceQueueItemsResponse.SerializeToString,
            ),
            'StreamGatewayTaskResult': grpc.stream_unary_rpc_method_handler(
                    servicer.StreamGatewayTaskResult,
                    request_deserializer=as_dot_as__pb2.GatewayTaskResult.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'GetDictionary': grpc.unary_unary_rpc_method_handler(
                    servicer.GetDictionary,
                    request_deserializer=as_dot_as__pb2.GetDictionaryRequest.FromString,
                    response_serializer=as_dot_as__pb2.GetDictionaryResponse.SerializeToString,
            ),
            'GetGWMetaData': grpc.unary_unary_rpc_method_handler(
                    servicer.GetGWMetaData,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=as_dot_as__pb2.GetGWMetaDataResponse.SerializeToString,
            ),
            'GetServiceProfile': grpc.unary_unary_rpc_method_handler(
                    servicer.GetServiceProfile,
                    request_deserializer=as_dot_as__pb2.GetServiceProfileRequest.FromString,
                    response_serializer=as_dot_as__pb2.GetServiceProfileResponse.SerializeToString,
            ),
            'CreateServiceProfile': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateServiceProfile,
                    request_deserializer=as_dot_as__pb2.CreateServiceProfileRequest.FromString,
                    response_serializer=as_dot_as__pb2.CreateServiceProfileResponse.SerializeToString,
            ),
            'UpdateSPonDevice': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateSPonDevice,
                    request_deserializer=as_dot_as__pb2.UpdateSPonDeviceRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'NewAppSKey': grpc.unary_unary_rpc_method_handler(
                    servicer.NewAppSKey,
                    request_deserializer=as_dot_as__pb2.NewAppSKeyRequest.FromString,
                    response_serializer=as_dot_as__pb2.GetDeviceAppSKeyResponse.SerializeToString,
            ),
            'CheckJwt': grpc.unary_unary_rpc_method_handler(
                    servicer.CheckJwt,
                    request_deserializer=as_dot_as__pb2.CheckJwtRequest.FromString,
                    response_serializer=as_dot_as__pb2.CheckJwtResponse.SerializeToString,
            ),
    }
...
class ApplicationServerService(object):
    ...
    def HandleUplinkData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/HandleUplinkData',
            as_dot_as__pb2.HandleUplinkDataRequest.SerializeToString,
    ...
    def HandleProprietaryUplink(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/HandleProprietaryUplink',
            as_dot_as__pb2.HandleProprietaryUplinkRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def HandleError(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/HandleError',
            as_dot_as__pb2.HandleErrorRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def HandleDownlinkACK(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/HandleDownlinkACK',
            as_dot_as__pb2.HandleDownlinkACKRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def HandleGatewayStats(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/HandleGatewayStats',
            as_dot_as__pb2.HandleGatewayStatsRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def HandleTxAck(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/HandleTxAck',
            as_dot_as__pb2.HandleTxAckRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def SetDeviceStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/SetDeviceStatus',
            as_dot_as__pb2.SetDeviceStatusRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def SetDeviceLocation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/SetDeviceLocation',
            as_dot_as__pb2.SetDeviceLocationRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def GetDevicesSummary(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/GetDevicesSummary',
            as_dot_as__pb2.GetDevicesSummaryRequest.SerializeToString,
            as_dot_as__pb2.GetDevicesSummaryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetGatewaysSummary(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/GetGatewaysSummary',
            as_dot_as__pb2.GetGatewaysSummaryRequest.SerializeToString,
            as_dot_as__pb2.GetGatewaysSummaryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ListOrganisation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/ListOrganisation',
            as_dot_as__pb2.ListOrganizationRequest.SerializeToString,
            as_dot_as__pb2.ListOrganizationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetOrgByDevEUI(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/GetOrgByDevEUI',
            as_dot_as__pb2.GetOrgByDevEUIRequest.SerializeToString,
            as_dot_as__pb2.GetOrgByDevEUIResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetOrgIDByGwID(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/GetOrgIDByGwID',
            as_dot_as__pb2.GetOrgIDByGwIDRequest.SerializeToString,
            as_dot_as__pb2.GetOrgByDevEUIResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def GetDeviceAppSKey(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/as.ApplicationServerService/GetDeviceAppSKey',
            as_dot_as__pb2.GetOrgByDevEUIRequest.SerializeToString,
            as_dot_as__pb2.GetDeviceAppSKeyResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetDeviceKeys(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/as.ApplicationServerService/GetDeviceKeys',
            as_dot_as__pb2.GetOrgByDevEUIRequest.SerializeToString,
            as_dot_as__pb2.GetDeviceKeysResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ReEncryptDeviceQueueItems(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/ReEncryptDeviceQueueItems',
            as_dot_as__pb2.ReEncryptDeviceQueueItemsRequest.SerializeToString,
            as_dot_as__pb2.ReEncryptDeviceQueueItemsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def StreamGatewayTaskResult(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/as.ApplicationServerService/StreamGatewayTaskResult',
            as_dot_as__pb2.GatewayTaskResult.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def GetDictionary(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/GetDictionary',
            as_dot_as__pb2.GetDictionaryRequest.SerializeToString,
            as_dot_as__pb2.GetDictionaryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetGWMetaData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            as_dot_as__pb2.GetGWMetaDataResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetServiceProfile(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/GetServiceProfile',
            as_dot_as__pb2.GetServiceProfileRequest.SerializeToString,
            as_dot_as__pb2.GetServiceProfileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def CreateServiceProfile(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/CreateServiceProfile',
            as_dot_as__pb2.CreateServiceProfileRequest.SerializeToString,
            as_dot_as__pb2.CreateServiceProfileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def UpdateSPonDevice(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/UpdateSPonDevice',
            as_dot_as__pb2.UpdateSPonDeviceRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def NewAppSKey(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/NewAppSKey',
            as_dot_as__pb2.NewAppSKeyRequest.SerializeToString,
            as_dot_as__pb2.GetDeviceAppSKeyResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def CheckJwt(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/as.ApplicationServerService/CheckJwt',
            as_dot_as__pb2.CheckJwtRequest.SerializeToString,
            as_dot_as__pb2.CheckJwtResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
