...
_UPLINKEVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mic', full_name='integration.UplinkEvent.mic', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='late', full_name='integration.UplinkEvent.late', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='time', full_name='integration.UplinkEvent.time', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='published_at', full_name='integration.UplinkEvent.published_at', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='device_profile_id', full_name='integration.UplinkEvent.device_profile_id', index=19,
    ...
    _descriptor.FieldDescriptor(
      name='device_profile_name', full_name='integration.UplinkEvent.device_profile_name', index=20,
...
_UPLINKEVENT.fields_by_name['time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
