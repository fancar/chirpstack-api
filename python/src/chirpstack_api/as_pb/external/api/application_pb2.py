...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _APPLICATIONSERVICE.methods_by_name['CreateKafkaIntegration']._options = None
  _APPLICATIONSERVICE.methods_by_name['CreateKafkaIntegration']._serialized_options = b'\202\323\344\223\002F\"A/api/applications/{integration.application_id}/integrations/kafka:\001*'
  _APPLICATIONSERVICE.methods_by_name['GetKafkaIntegration']._options = None
  _APPLICATIONSERVICE.methods_by_name['GetKafkaIntegration']._serialized_options = b'\202\323\344\223\0027\0225/api/applications/{application_id}/integrations/kafka'
  _APPLICATIONSERVICE.methods_by_name['UpdateKafkaIntegration']._options = None
  _APPLICATIONSERVICE.methods_by_name['UpdateKafkaIntegration']._serialized_options = b'\202\323\344\223\002F\032A/api/applications/{integration.application_id}/integrations/kafka:\001*'
  _APPLICATIONSERVICE.methods_by_name['DeleteKafkaIntegration']._options = None
  _APPLICATIONSERVICE.methods_by_name['DeleteKafkaIntegration']._serialized_options = b'\202\323\344\223\0027*5/api/applications/{application_id}/integrations/kafka'
  ...
  _APPLICATIONSERVICE.methods_by_name['CreateMQTTIntegration']._options = None
  _APPLICATIONSERVICE.methods_by_name['CreateMQTTIntegration']._serialized_options = b'\202\323\344\223\002E\"@/api/applications/{integration.application_id}/integrations/mqtt:\001*'
  _APPLICATIONSERVICE.methods_by_name['GetMQTTIntegration']._options = None
  _APPLICATIONSERVICE.methods_by_name['GetMQTTIntegration']._serialized_options = b'\202\323\344\223\0026\0224/api/applications/{application_id}/integrations/mqtt'
  _APPLICATIONSERVICE.methods_by_name['UpdateMQTTIntegration']._options = None
  _APPLICATIONSERVICE.methods_by_name['UpdateMQTTIntegration']._serialized_options = b'\202\323\344\223\002E\032@/api/applications/{integration.application_id}/integrations/mqtt:\001*'
  _APPLICATIONSERVICE.methods_by_name['DeleteMQTTIntegration']._options = None
  _APPLICATIONSERVICE.methods_by_name['DeleteMQTTIntegration']._serialized_options = b'\202\323\344\223\0026*4/api/applications/{application_id}/integrations/mqtt'
